...
class MetaPathUtilityTest(unittest.TestCase):
    ...
    def testFindMetaPathNeighborsLengthTwo(self):
        ...
        }, self.metaPathUtility.findMetaPathNeighbors(
    ...
    def testFindOddLengthRepeatedMetaPathNeighbors(self):
        """
          Tests finding the meta path neighbors when the meta paths are loops
        """

        # Co-authorship
        self.assertEquals({
            self.coauthor, self.author
        }, self.metaPathUtility.findMetaPathNeighbors(
    ...
    def testFindOddLengthSymmetricMetaPaths(self):
        ...
        self.assertEquals([
            [self.author, self.paper3, self.coauthor]
        ], self.metaPathUtility.findMetaPaths(self.templateGraph, self.author,
    ...
    def testExpandPartialMetaPathOddUnweighted(self):
        ...
        self.assertEquals(
            [Author, Paper, Author],
            self.metaPathUtility.expandPartialMetaPath([Author, Paper])
        )
    ...
    def testExpandPartialMetaPathEvenUnweighted(self):
        ...
        self.assertEquals(
            ...
            self.metaPathUtility.expandPartialMetaPath([Author, Paper], True)
        )
    ...
    def testFindLoopMetaPaths(self):
        ...
        actualPaths = self.metaPathUtility.findMetaPaths(
