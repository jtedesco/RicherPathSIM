from experiment.real.four_area.barebones import AuthorsNeighborSimAPPAExperiment, AuthorsNeighborSimAPPAAPCPAExperiment
...
citationCounts = AuthorsNeighborSimAPPAAPCPAExperiment.run(citationCounts = citationCounts, weights = (0.4,0.6))
print("Running NeighborSim APPA - PathSim APCPA experiment (0.6, 0.4:")
citationCounts = AuthorsNeighborSimAPPAAPCPAExperiment.run(citationCounts = citationCounts, weights = (0.6,0.4))
print("Running NeighborSim APPA - PathSim APCPA experiment (0.3, 0.7:")
citationCounts = AuthorsNeighborSimAPPAAPCPAExperiment.run(citationCounts = citationCounts, weights = (0.3,0.7))
print("Running NeighborSim APPA - PathSim APCPA experiment (0.2, 0.8:")
citationCounts = AuthorsNeighborSimAPPAAPCPAExperiment.run(citationCounts = citationCounts, weights = (0.2,0.8))
print("Running NeighborSim APPA - PathSim APCPA experiment (0.1, 0.9:")
citationCounts = AuthorsNeighborSimAPPAAPCPAExperiment.run(citationCounts = citationCounts, weights = (0.1,0.9))