...
citationCounts, publicationCounts = AuthorsNeighborSimAPPAExperiment.run()
print("Running NeighborSim PPA experiment:")
AuthorsNeighborSimPPAExperiment.run(citationCounts, publicationCounts)
...
AuthorsNeighborSimAPPAAPCPAExperiment.run(citationCounts, publicationCounts)
print("Running NeighborSim APPA - PathSim APCPA experiment (0.4, 0.6:")
AuthorsNeighborSimAPPAAPCPAExperiment.run(citationCounts, publicationCounts, weights = (0.4,0.6))
print("Running NeighborSim APPA - PathSim APCPA experiment (0.6, 0.4:")
AuthorsNeighborSimAPPAAPCPAExperiment.run(citationCounts, publicationCounts, weights = (0.6,0.4))
print("Running NeighborSim APPA - PathSim APCPA experiment (0.3, 0.7:")
AuthorsNeighborSimAPPAAPCPAExperiment.run(citationCounts, publicationCounts, weights = (0.3,0.7))
print("Running NeighborSim APPA - PathSim APCPA experiment (0.2, 0.8:")
AuthorsNeighborSimAPPAAPCPAExperiment.run(citationCounts, publicationCounts, weights = (0.2,0.8))
print("Running NeighborSim APPA - PathSim APCPA experiment (0.1, 0.9:")
AuthorsNeighborSimAPPAAPCPAExperiment.run(citationCounts, publicationCounts, weights = (0.1,0.9))